...
import { Button, TextInput, View, Text, StyleSheet, Switch, TouchableOpacity, Keyboard } from 'react-native';
...
const NewExpense = ({ route, navigation }) => {
        ...
        <Background>
            <Formik
                ...
                onSubmit={values => {
                    ...
                    values.trip_id = route.params.trip.id;
                    console.log("New Expense ===> ", values);

                    expenseRef.add(values)
                        .then((docRef) => {
                        ...
                        .catch((error) => {
                            alert("Failed to add new expense. Error: ", error);
                        });
                    ...
                    <ScrollView
                        ...
                        <View style={{ padding: 10, marginTop: 100 }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 10 }}>
                                <View style={{ flexDirection: 'column' }}>
                                    ...
                                    <TextInput
                                        ...
                                        value={dates.getDate() + '/' + (dates.getMonth() + 1) + '/' + dates.getFullYear()}
                                ...
                                <View style={{ flexDirection: 'column', paddingLeft: 12 }}>
                                    ...
                                    <TextInput
                                        ...
                                        value={dates.getHours() + ':' + dates.getMinutes()}
                                        placeholder="hh:mm"
                                    />
                                </View>
                            </View>
                            ...
                            <TouchableOpacity
                                ...
                                style={styles.button}
                            >
                                <Text style={{ fontFamily: 'Geomanist', fontSize: 18, color: '#bd8dab' }}>Add new expense</Text>
                            </TouchableOpacity>
                            {/* <Button title='Add new expense' onPress={handleSubmit} /> */}
                        </View>
                    </ScrollView>
                )}
            </Formik>
